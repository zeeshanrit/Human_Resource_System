...
<body>
    <div class="container">
        ...
        <div class="text-center btn-container">
            ...
            <a href="update?id=<%=emp.getEmpno()%>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
            <a href="delete?id=<%=emp.getEmpno()%>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Delete</a>
        </div>
    </div>
</body>
</html>
